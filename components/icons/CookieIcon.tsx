// Vendored from Phosphor Icons (`ph:cookie`, regular weight, MIT license,
// https://phosphoricons.com) via the Iconify API. Path data unmodified.
import type { SVGProps } from "react";

export default function CookieIcon(props: SVGProps<SVGSVGElement>) {
  return (
